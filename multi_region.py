...
if __name__ == '__main__':
    ...
    output_root = f'data{os.sep}spikeinterface-0_98_2{os.sep}MultiRegion5'
    sorter_parameters = {
        'detect_sign': -1,
        'adjacency_radius': -1, 
        'freq_min': 300, 
    ...
    for mouse in mice: 
        session_paths = glob.glob(f'{input_root}{os.sep}{mouse}{os.sep}**')
        for session_path in session_paths:
            if today is not None:
                print(f'Skipping {session_path}')
                if today not in session_path:
                    continue
    ...
    input_root = f'data{os.sep}raw{os.sep}MultiRegion'
    output_root = f'data{os.sep}spikeinterface-0_98_2{os.sep}MultiRegion4'
    sorter_parameters = {
        'detect_sign': -1,
        'adjacency_radius': -1, 
        'freq_min': 300, 
